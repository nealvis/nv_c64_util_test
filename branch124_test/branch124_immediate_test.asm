...
title_str: .text @"BRANCH124 IMMED\$00"          // null terminated string to print
                                                 // via the BASIC routine
title_cmp124u_str: .text @"TEST CMP124U IMMED \$00"
title_beq124u_str: .text @"TEST BEQ124U IMMED \$00"
title_bne124u_str: .text @"TEST BNE124U IMMED \$00"
title_blt124u_str: .text @"TEST BLT124U IMMED \$00"
title_ble124u_str: .text @"TEST BLE124U IMMED \$00"
title_bgt124u_str: .text @"TEST BGT124U IMMED \$00"
title_bge124u_str: .text @"TEST BGE124U IMMED \$00"

title_cmp124s_str: .text @"TEST CMP124S IMMED \$00"
title_beq124s_str: .text @"TEST BEQ124S IMMED \$00"
title_bne124s_str: .text @"TEST BNE124S IMMED \$00"
title_blt124s_str: .text @"TEST BLT124S IMMED \$00"
title_ble124s_str: .text @"TEST BLE124S IMMED \$00"
title_bgt124s_str: .text @"TEST BGT124S IMMED \$00"
title_bge124s_str: .text @"TEST BGE124S IMMED \$00"
...
.macro test_cmp124s(init_row)
{
    ...
    /////////////////////////////
    nv_screen_plot_cursor(row++, 0)
    print_cmp124_immed(true, op124_0000, $0000, CMP_EQUAL)

    /////////////////////////////
    nv_screen_plot_cursor(row++, 0)
    print_cmp124_immed(true, op124_0000, $8000, CMP_EQUAL)

    /////////////////////////////
    nv_screen_plot_cursor(row++, 0)
    print_cmp124_immed(true, op124_8000, $0000, CMP_EQUAL)

    /////////////////////////////
    nv_screen_plot_cursor(row++, 0)
    print_cmp124_immed(true, op124_8000, $8000, CMP_EQUAL)

    /////////////////////////////
    nv_screen_plot_cursor(row++, 0)
    print_cmp124_immed(true, op124_0001, $8000, CMP_GREATER)

    /////////////////////////////
    nv_screen_plot_cursor(row++, 0)
    print_cmp124_immed(true, op124_8001, $8000, CMP_LESS)
    ...
    /////////////////////////////
    nv_screen_plot_cursor(row++, 0)
    print_cmp124_immed(true, op1Beef, $FFFF, CMP_GREATER)

    /////////////////////////////
    nv_screen_plot_cursor(row++, 0)
    print_cmp124_immed(true, op1Beef, $0002, CMP_LESS)

    /////////////////////////////
    nv_screen_plot_cursor(row++, 0)
    print_cmp124_immed(true, op124_003E, $BEEF, CMP_GREATER)

    /////////////////////////////
    nv_screen_plot_cursor(row++, 0)
    print_cmp124_immed(true, op124_8000, $0030, CMP_LESS)

    /////////////////////////////
    nv_screen_plot_cursor(row++, 0)
    print_cmp124_immed(true, op124_803E, $003E, CMP_LESS)

    /////////////////////////////
    nv_screen_plot_cursor(row++, 0)
    print_cmp124_immed(true, op124_8030, $8040, CMP_GREATER)

    /////////////////////////////
    nv_screen_plot_cursor(row++, 0)
    print_cmp124_immed(true, op124_8030, $8130, CMP_GREATER)

    /////////////////////////////
    nv_screen_plot_cursor(row++, 0)
    print_cmp124_immed(true, op124_0034, $0010, CMP_GREATER)

    /////////////////////////////
    nv_screen_plot_cursor(row++, 0)
    print_cmp124_immed(true, op124_0010, $0034, CMP_LESS)

    /////////////////////////////
    nv_screen_plot_cursor(row++, 0)
    print_cmp124_immed(true, op124_8010, $8034, CMP_GREATER)

    /////////////////////////////
    nv_screen_plot_cursor(row++, 0)
    print_cmp124_immed(true, op124_8034, $8010, CMP_LESS)

    /////////////////////////////
    nv_screen_plot_cursor(row++, 0)
    print_cmp124_immed(true, op124_8034, $0034, CMP_LESS)

    /////////////////////////////
    nv_screen_plot_cursor(row++, 0)
    print_cmp124_immed(true, op124_FE00, $7E00, CMP_LESS)

    /////////////////////////////
    nv_screen_plot_cursor(row++, 0)
    print_cmp124_immed(true, op124_7E00, $FE00, CMP_GREATER)
...
.macro print_beq124_immed(signed, addr1, num, expect_to_branch)
{
    ...
    {
        nv_beq124u_immed(addr1, num, BranchTarget)
    }
    .if (expect_to_branch)
    {
        lda #0 
...
.macro print_bne124_immed(signed, addr1, num, expect_to_branch)
{
    ...
    {
        nv_bne124u_immed(addr1, num, BranchTarget)
    }
    .if (expect_to_branch)
    {
        lda #0 
...
.macro print_blt124_immed(signed, addr1, num, expect_to_branch)
{
    ...
    {
        nv_blt124u_immed(addr1, num, BranchTarget)
    }
    .if (expect_to_branch)
    {
        lda #0 
...
.macro print_ble124_immed(signed, addr1, num, expect_to_branch)
{
    ...
    {
        nv_ble124u_immed(addr1, num, BranchTarget)
    }
    .if (expect_to_branch)
    {
        lda #0 
...
.macro print_bgt124_immed(signed, addr1, num, expect_to_branch)
{
    ...
    {
        nv_bgt124u_immed(addr1, num, BranchTarget)
    }
    .if (expect_to_branch)
    {
        lda #0 
...
.macro print_bge124_immed(signed, addr1, num, expect_to_branch)
{
    ...
    {
        nv_bge124u_immed(addr1, num, BranchTarget)
    }
