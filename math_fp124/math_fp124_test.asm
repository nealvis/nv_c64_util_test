...
.macro CallCorrectAdc124s(op1_fp124s, op2_fp124s, result_fp124s)
{
    ...
    .if (routine_to_call == CALL_NEW_RUIN_OPS)
    {
        ...
        nv_call_NvAdc124sRuinOps(op1_fp124s, op2_fp124s, result_fp124s, (result_fp124s != 0), true)
    }
    else
    {
        //jsr NvAdc124s
        nv_call_NvAdc124s(op1_fp124s, op2_fp124s, result_fp124s, (result_fp124s != 0), true)
    }
